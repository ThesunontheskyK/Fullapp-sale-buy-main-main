      ...
      {qrcode ? (
          <View className="flex-1 justify-center items-center bg-black/50">
            <View className="bg-white w-11/12 p-5 rounded-lg">
              {/* ชื่อผู้ชำระเงิน */}
              <Text className="text-lg font-semibold mb-2 text-center text-gray-800">
                บริษัท เซฟโปร จำกัด
              </Text>
              ...
              <View className="w-full rounded-md h-[40vh] mb-4 flex justify-center items-center">
                <Image
              ...
              <TouchableOpacity
                className="bg-gray-300 py-3 rounded-lg mb-3"
                onPress={onClose}
              >
              ...
              <TouchableOpacity
                className="bg-[#125c91] py-3 rounded-lg"
              >
